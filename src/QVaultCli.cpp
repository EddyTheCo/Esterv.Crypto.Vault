...
int main(int argc, char *argv[])
{
    ...
    parser.addPositionalArgument("data", QCoreApplication::translate("main", "data to store on the vault. Only on Set Mode."));
    ...
    QCommandLineOption getO(QStringList() << "g" << "get", QCoreApplication::translate("main", "get data from the vault => Get Mode."));
    parser.addOption(getO);
    QCommandLineOption setO(QStringList() << "s" << "set", QCoreApplication::translate("main", "set the data of the vault => Set Mode."));
